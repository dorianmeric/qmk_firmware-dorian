...
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,                   xxxx, xxxx,         J_KEY,              KC_L,              KC_U,             KC_Y,              KC_SLSH,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,                   xxxx, xxxx,         KC_M,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
KC_Z,               ALGR_T(KC_X),      KC_C,              KC_D,              KC_V,                  xxxx, xxxx,         KC_K,              KC_H,              KC_COMM,          ALGR_T(KC_DOT),    KC_QUOT,             \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_MOUSE,KC_TAB), LT(U_NAV,KC_SPC),      xxxx, xxxx,         LT(U_NUM,KC_BSPC), LT(U_SYM,KC_ENT), LT(U_FUN,KC_DEL),   U_NP,              U_NP
...
U_NP,              U_NP,              xxxx,              xxxx,              xxxx,                   xxxx, xxxx,         KC_BSPC,           KC_ENT,           KC_DEL,            U_NP,              U_NP
...
U_NP,              U_NP,              xxxx,              xxxx,              xxxx,                   xxxx, xxxx,         KC_BTN1,           KC_BTN2,           KC_BTN3,           U_NP,              U_NP
...
U_NP,              U_NP,              xxxx,              xxxx,              xxxx,                   xxxx, xxxx,         KC_MUTE,        KC_MEDIA_PLAY_PAUSE,  KC_MEDIA_STOP,     U_NP,              U_NP
...
U_NP,              U_NP,              KC_DOT,            KC_0,              KC_MINS,                xxxx, xxxx,         KC_BSPC,           xxxx,              xxxx,              U_NP,              U_NP
...
U_NP,              U_NP,              xxxx,              KC_RPRN,           KC_UNDS,                xxxx, xxxx,         KC_BSPC,           xxxx,              xxxx,              U_NP,              U_NP

// BOTH RIGHT
#define MIRYOKU_ALTERNATIVES_FUN \
KC_F12,            KC_F7,             KC_F8,             KC_F9,             KC_PSCR,                xxxx, xxxx,         xxxx,              xxxx,              DF(U_BASE),       DF(U_EXTRA),       TD(U_TD_BOOT),            \
...
U_NP,              U_NP,              xxxx,              KC_TAB,            KC_SPC,                 xxxx, xxxx,         xxxx,              xxxx,              xxxx,              U_NP,              U_NP
